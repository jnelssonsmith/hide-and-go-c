...
int getWidth(FILE *inputFP, FILE *outputFP);
int getHeight(FILE *inputFP, FILE *outputFP);
void scanToNextVal(FILE *inputFile, FILE *outputFile);
int getColourRange(FILE *inputFP, FILE *outputFP);
...
int main(int argc, char **argv) {
	...
	if(argc != 3) {
		...
		if(isRawPPM(inputFP, outputFP)){
			...
			width = getWidth(inputFP, outputFP);
			scanToNextVal(inputFP, outputFP);
			height = getHeight(inputFP, outputFP);
			scanToNextVal(inputFP, outputFP);
			colourRange = getColourRange(inputFP, outputFP);
			scanToNextVal(inputFP, outputFP);
